                        ...
                        <form action="{{ route('routine.store') }}" method="POST" enctype="multipart/form-data" id="upload-form">
                            ...
                            <div class="form-group">
                                <label class="d-block" for="fileElem">
                                    ...
                                    <input type="file" id="file_path" name="file_path" class="form-control p-2" style="border-radius: 10px;">
                                </label>
                                <p class="mt-2 text-muted">Drag and drop files here or click to select</p>
                            </div>
                            <div class="form-group">
                                <label for="image">Upload Routine</label>
                ...
                <div class="card-body">
                    <div id="drop-area" class="border rounded p-4 text-center bg-light shadow-sm">
                        <form action="{{ route('routine.store') }}" method="POST" enctype="multipart/form-data" id="upload-form">
                            ...
                            <div class="form-group">
                                <label for="image">Upload Routine Image</label>
                                <input type="file" id="image" name="image"  placeholder="Image">
                            </div>
                            ...
                            <div class="form-group">
                                <label class="d-block" for="fileElem">
                                    <i class="fa-solid fa-cloud-arrow-up fa-4x text-primary mb-3"></i>
                                    <input type="file" id="fileElem" placeholder="Only File PDF/Doc " name="file" class="form-control p-2" style="border-radius: 10px;">
                                </label>
                                <p class="mt-2 text-muted">Drag and drop files here or click to select</p>
                            </div>
