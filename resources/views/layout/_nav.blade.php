...
<header id="header" class="fixed-top">
        ...
        <div class="container d-flex align-items-center">
            ...
            <h1 class="logo me-auto"><a href="{{route('home')}}"><img src="{{asset('frontend/logo/sg-logo.png')}}" alt="" class="rounded"></a></h1>
          ...
          <nav id="navbar" class="navbar">
            <ul>
              ...
              <li>
                <div class="dropdown">
                    <a class="nav-link scrollto" href="#">Service Category</a>
                    <div class="dropdown-content ms-auto rounded">
                      <a target="_blank" href="{{route('admission_eligibility')}}" class="nav-link text-info">Private Organization</a>
                      <a target="_blank" href="{{route('Local_tuition')}}" class="nav-link text-info">Government</a>
                      <a target="_blank" href="{{route('international_tuition')}}" class="nav-link text-info">International </a>
                      <a target="_blank" href="https://daffodilvarsity.edu.bd/admission-test" class="nav-link text-info">E-Commerce</a>
                    </div>
                  </div>
              </li>
              ...
              <li><a class="nav-link scrollto"  href="{{route('program')}}">Gallery</a></li>
              <li><a class="nav-link scrollto" href="{{route('faculty.member')}}">Team</a></li>
               <li>
                <div class="dropdown rounded">
                <a class="nav-link scrollto" href="#">Blogs</a>
