...
{{-- <div class="container-fluid">
    <div class="row text-light">
      <div class="col-md-6 col-sm-6 py-1 text-left topbar-icon">
        ...
        <a class="text-dark p-2" href="mailto:itmoffice@daffodilvarsity.edu.bd"><i class="fa-solid fa-envelope icontop"></i></a>
        <a class="text-dark p-2" href="tel:01847-140039"><i class="fa-solid fa-square-phone icontop"></i></a>
      </div>
      <div class="col-md-6 col-sm-6 py-1 topbar-btn-container ">
