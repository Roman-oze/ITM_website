...
@section('main')
    <div class="container py-4">
        ...
        <div class="modern-card">
            ...
            <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <div>
                    <h4 class="mb-0"> Mail Management</h4>
                    <small class="text-muted">sent mail to team members and stuffs</small>
                </div>

                <button type="button" class="btn btn-info-custom" data-bs-toggle="modal" data-bs-target="#infoModal">
                ...
                <div class="custom-tab-container d-inline-flex p-1">
                    <ul class="nav nav-pills" id="mailTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active custom-pill-btn" id="batch-tab" data-bs-toggle="tab"
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link custom-pill-btn" id="manual-tab" data-bs-toggle="tab"
            ...
            <div class="tab-content" id="mailTabContent">
                <div class="tab-pane fade show active" id="batch" role="tabpanel" aria-labelledby="batch-tab">
                    <form action="{{ route('send.mail.data') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row align-items-start mb-4">
                            ...
                            <div class="col-md-6">
                                <label for="attachment" class="custom-field-label">Attachment</label>
                                <div class="input-field-container d-flex align-items-stretch">
                                    <div class="input-file-display flex-grow-1 d-flex align-items-center ps-3">
                                        <i class="fas fa-paperclip text-blue-muted me-2"></i>
                                        <span id="file-chosen-name" class="text-muted-placeholder">Choose file</span>
                                    </div>
                                    <label for="attachment"
                                        class="btn btn-browse-custom m-0 d-flex align-items-center justify-content-center">Browse</label>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="form-control custom-dark-textarea" name="message" id="message" rows="6"
                ...
                <div class="tab-pane fade" id="manual" role="tabpanel" aria-labelledby="manual-tab">
                    <form action="{{ route('send.mail.data') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6 mb-3 mb-md-0">
                                ...
                                <div class="input-field-container">
                                    ...
                                    <input type="text" class="custom-dark-input-text" name="emails" id="emails"
                                        placeholder="Enter additional email addresses" value="{{ old('emails') }}" />
                                </div>
                            ...
                            <div class="col-md-6">
                                <label for="attachmentManual" class="custom-field-label">Attachment</label>
                                <div class="custom-file-upload-group d-flex align-items-stretch">
                                    <div class="input-file-display flex-grow-1 d-flex align-items-center ps-3">
                                        <i class="fas fa-paperclip text-blue-muted me-2"></i>
                                        <span id="file-chosen-name-manual" class="text-muted-placeholder">Choose
                                            file</span>
                                    </div>
                                    <label for="attachmentManual"
                                        class="btn btn-browse-custom m-0 d-flex align-items-center justify-content-center">Browse</label>
                                    <input type="file" class="d-none" name="attachment" id="attachmentManual" />
                                </div>
                                <div class="custom-field-desc mt-2">
                                    Supported formats: PDF, DOC, JPG, PNG
                                </div>
                        ...
                        <div class="mb-4">
                            <label for="messageManual" class="custom-field-label">Message</label>
                            <textarea class="form-control custom-dark-textarea" name="message" id="messageManual" rows="6"
                                placeholder="Enter your message here..." required>
                                {{ old('message') }}</textarea>
                        </div>
    ...
    <style>
        ...
        .custom-dark-input option {
            ...
            /* Matches your main card panel background */
            color: #cbd5e1 !important;
            /* Light grey/white readable text */
        ...
        .custom-dark-input option {
            border: 1px solid #162e4e !important;
            /* Changes the white line to your deep blue theme border */
            outline: none !important;
            /* Removes fallback OS focus outlines */
        }
