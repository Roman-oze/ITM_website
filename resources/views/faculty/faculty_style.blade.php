...
/**
* Template Name: Software Giant
* Updated: Mar 17 2024 with Bootstrap v5.3.3
* Author: SoftwareGiant
*/
  ...
  */
  ...
  .cta {
    background: linear-gradient(rgba(40, 58, 90, 0.9), rgba(40, 58, 90, 0.9)),
      url("../image/cta-bg.jpg") fixed center center;
    background-size: cover;
    padding: 120px 0;
  }
  ...
  .product-btn {
    --bs-btn-color: #fff;
    --bs-btn-bg: #465c85;
    --bs-btn-border-color: align-items-end d-flex;
    --bs-btn-hover-color: #fff;
    --bs-btn-hover-bg: #465c85;
    --bs-btn-hover-border-color: #465c85;
