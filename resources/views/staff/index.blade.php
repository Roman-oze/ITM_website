                ...
                <form id="editStaffForm" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input id="edit_staff_name" type="text" name="name" class="form-control modern-input">
                ...
                <div class="modal-dialog modal-lg modal-dialog-centered">
                    ...
                    <div class="modal-content modern-modal">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-4 text-center">
                                    ...
                                    <img src="{{ asset($staff->image) }}" class="faculty-profile-image"
                                        alt="{{ $staff->name }}">
                        ...
                        <div class="modal-footer modern-modal-footer">
                            ...
                            @can('update user')
                                <button type="button" class="btn-save editStaffBtn" data-id="{{ $staff->id }}"
                                    data-name="{{ $staff->name }}" data-position="{{ $staff->position }}"
                                    data-email="{{ $staff->email }}" data-mobile="{{ $staff->mobile }}"
                                    data-image="{{ asset($staff->image) }}" data-bs-toggle="modal"
