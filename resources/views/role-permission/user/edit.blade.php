...
@section('main')
    <main>
         ...
         <div class="limiter mt-5">
            <h4>
                <a href="{{ url('users') }}" class=" m-1 p-3"><i class="fa-solid fa-arrow-left text-white"></i></a>
            </h4>
                ...
                <div class="wrap-login100">
                    ...
                    <form action="{{ route('users.store') }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="wrap-input100 validate-input" data-validate="At least one role must be selected">
                            <label for="roles" class="form-label fw-bold mb-3">
                                Select Roles
                            </label>
                            ...
                            <div class="role-checkbox-container d-flex flex-wrap gap-3">
                                ...
                                @foreach ($roles as $role)
                                    <div class="role-checkbox">
                                        ...
                                        <input class="role-checkbox-input" type="checkbox" name="roles[]"
                                            id="role-{{ Str::slug($role) }}" value="{{ $role }}"
                                            {{ in_array($role, $userRoles) ? 'checked' : '' }}>

                                        <label class="role-checkbox-label" for="role-{{ Str::slug($role) }}">
                                            <div class="role-icon">
